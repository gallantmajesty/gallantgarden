...
export const LOGOS: Logo[] = [
  ...
  { id: 'neon_avatar', name: 'Neon', image: '/banners/neon_anime_avatar.webp', category: 'others', price: 1000,
    filter: { brightness: 0.68, contrast: 1.15, saturate: 1.2 } },
  { id: 'angel_logo', name: 'Angel', image: '/banners/chibi_angel_logo_1.webp', category: 'others', price: 1000,
  ...
  { id: 'chibi_angel_2', name: 'Angel II', image: '/banners/chibi_angel_logo_2.webp', category: 'others', price: 1000,
    filter: { brightness: 0.78, contrast: 1.1, saturate: 0.9 } },
  { id: 'chibi_angel_3', name: 'Angel III', image: '/banners/chibi_angel_logo_3.webp', category: 'others', price: 1000,
    filter: { brightness: 0.8, contrast: 1.1, saturate: 0.92 } },
  { id: 'chibi_cat_girl', name: 'Cat Girl', image: '/banners/chibi_cat_girl_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.78, contrast: 1.12, saturate: 1.05 } },
  { id: 'chibi_cyberpunk', name: 'Cyber Chibi', image: '/banners/chibi_cyberpunk_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.72, contrast: 1.2, saturate: 1.3, hueRotate: -5 } },
  { id: 'cyberpunk_warrior', name: 'Cyber Warrior', image: '/banners/chibi_cyberpunk_warrior_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.82, contrast: 1.15, saturate: 1.1 } },
  { id: 'chibi_mage', name: 'Mage', image: '/banners/chibi_mage_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.6, contrast: 1.2, saturate: 1.15, hueRotate: 10 } },
  { id: 'chibi_moon_spirit', name: 'Moon Spirit', image: '/banners/chibi_moon_spirit_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.55, contrast: 1.25, saturate: 1.1, hueRotate: -10 } },
  { id: 'chibi_dragon', name: 'Rainbow Dragon', image: '/banners/chibi_rainbow_dragon_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.85, contrast: 1.1, saturate: 1.25 } },
  { id: 'chibi_robot', name: 'Robot', image: '/banners/chibi_robot_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 1.0, contrast: 1.15, saturate: 0.9 } },
  { id: 'chibi_samurai', name: 'Samurai', image: '/banners/chibi_samurai_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.85, contrast: 1.12, saturate: 1.05 } },
  { id: 'cloud_angel', name: 'Cloud Angel', image: '/banners/cloud_angel_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.6, contrast: 1.2, saturate: 0.85 } },
  { id: 'glitch_chibi', name: 'Glitch Chibi', image: '/banners/glitch_chibi_avatar_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.8, contrast: 1.18, saturate: 1.1, hueRotate: 5 } },
  { id: 'kawaii_angel', name: 'Kawaii Angel', image: '/banners/kawaii_angel_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.6, contrast: 1.15, saturate: 0.9 } },
  { id: 'neon_chibi_warrior', name: 'Neon Warrior', image: '/banners/neon_chibi_warrior_logo.webp', category: 'others', price: 1000,
    filter: { brightness: 0.7, contrast: 1.2, saturate: 1.35, hueRotate: -8 } },
  { id: 'star_child', name: 'Star Child', image: '/banners/star_child_logo.webp', category: 'others', price: 1000,
