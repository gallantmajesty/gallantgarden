...
export const BANNERS: Banner[] = [
  ...
  },
  {
    ...
    glow: '#ff4500',
    category: 'others',
    // pure CSS gradient — no artwork, so it's free like the other gradients
    price: 0,
  },
  {
    id: 'cyberpunk_neon',
  ...
  },
  {
    ...
    category: 'others',
    // premium art piece — golden leaves, below the golden characters (320)
    price: 200,
    currency: 'gold',
  },
...
export const LOGOS: Logo[] = [
  ...
  { id: 'neon_avatar', visible: true, name: 'Neon', image: '/banners/neon_anime_avatar.webp', category: 'others', price: 700,
    filter: { brightness: 0.68, contrast: 1.15, saturate: 1.2 } },
  { id: 'angel_logo', visible: true, name: 'Angel', image: '/banners/chibi_angel_logo_1.webp', category: 'others', price: 700,
    filter: { brightness: 0.78, contrast: 1.1, saturate: 0.9 } },
  { id: 'chibi_angel_2', visible: false, name: 'Angel II', image: '/banners/chibi_angel_logo_2.webp', category: 'others', price: 700,
    filter: { brightness: 0.78, contrast: 1.1, saturate: 0.9 } },
  { id: 'chibi_angel_3', visible: false, name: 'Angel III', image: '/banners/chibi_angel_logo_3.webp', category: 'others', price: 700,
    filter: { brightness: 0.8, contrast: 1.1, saturate: 0.92 } },
  { id: 'chibi_cat_girl', visible: false, name: 'Cat Girl', image: '/banners/chibi_cat_girl_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.78, contrast: 1.12, saturate: 1.05 } },
  { id: 'chibi_cyberpunk', visible: false, name: 'Cyber Chibi', image: '/banners/chibi_cyberpunk_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.72, contrast: 1.2, saturate: 1.3, hueRotate: -5 } },
  { id: 'cyberpunk_warrior', visible: false, name: 'Cyber Warrior', image: '/banners/chibi_cyberpunk_warrior_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.82, contrast: 1.15, saturate: 1.1 } },
  { id: 'chibi_mage', visible: false, name: 'Mage', image: '/banners/chibi_mage_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.6, contrast: 1.2, saturate: 1.15, hueRotate: 10 } },
  { id: 'chibi_moon_spirit', visible: false, name: 'Moon Spirit', image: '/banners/chibi_moon_spirit_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.55, contrast: 1.25, saturate: 1.1, hueRotate: -10 } },
  { id: 'chibi_dragon', visible: false, name: 'Rainbow Dragon', image: '/banners/chibi_rainbow_dragon_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.85, contrast: 1.1, saturate: 1.25 } },
  { id: 'chibi_robot', visible: false, name: 'Robot', image: '/banners/chibi_robot_logo.webp', category: 'others', price: 700,
    filter: { brightness: 1.0, contrast: 1.15, saturate: 0.9 } },
  { id: 'chibi_samurai', visible: false, name: 'Samurai', image: '/banners/chibi_samurai_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.85, contrast: 1.12, saturate: 1.05 } },
  { id: 'cloud_angel', visible: false, name: 'Cloud Angel', image: '/banners/cloud_angel_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.6, contrast: 1.2, saturate: 0.85 } },
  { id: 'glitch_chibi', visible: false, name: 'Glitch Chibi', image: '/banners/glitch_chibi_avatar_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.8, contrast: 1.18, saturate: 1.1, hueRotate: 5 } },
  { id: 'kawaii_angel', visible: false, name: 'Kawaii Angel', image: '/banners/kawaii_angel_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.6, contrast: 1.15, saturate: 0.9 } },
  { id: 'neon_chibi_warrior', visible: false, name: 'Neon Warrior', image: '/banners/neon_chibi_warrior_logo.webp', category: 'others', price: 700,
    filter: { brightness: 0.7, contrast: 1.2, saturate: 1.35, hueRotate: -8 } },
  { id: 'star_child', visible: false, name: 'Star Child', image: '/banners/star_child_logo.webp', category: 'others', price: 700,
