...
export const CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    yOffset: 0,
    fallback: look('female', {
      skin: 'porcelain', hair: 'twintails', hairColor: 'violet',
      eyes: 'violet',
      top: 'frock', bottom: 'leggings', shoes: 'sneakers',
      topColor: '#f4a0c8', bottomColor: '#2d1f3d',
    }),
    description: 'A kawaii anime schoolgirl with fluffy pink twintails, violet eyes and a dazzling smile',
    icon: '/icons/characters/sakura.svg',
    rarity: 'Epic',
    color: '#f4a0c8',
    bg: '#fde8f2',
    special: true,
