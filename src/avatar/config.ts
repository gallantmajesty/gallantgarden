...
export interface AccessoryDef {
  ...
  currency?: 'green' | 'gold'
  /** Shop visibility. Hidden accessories stay equippable (no data change);
...
export const ACCESSORIES: AccessoryDef[] = [
  ...
  { id: 'hourglass', visible: false, name: 'Focus Hourglass', icon: '⏳', color: '#d4af37', blurb: 'Sands of flow state', price: 600 },
  { id: 'water_bottle', visible: false, name: 'Water Bottle', icon: '🚰', color: '#7ba7c9', blurb: 'Stay hydrated', price: 250 },
  { id: 'headphones', visible: false, name: 'Headphones', icon: '🎧', color: '#2a2a35', blurb: 'Focus in sound', price: 500 },
  { id: 'desk_lamp', visible: false, name: 'Desk Lamp', icon: '💡', color: '#caa24a', blurb: 'Warm study glow', price: 450 },
